...
3. [ ] **Fusion des écrans en double** : « Statistiques » (15 services) fusionné dans « Indicateurs » (19 services) ; les 4 écrans génériques (Indicateurs, Planning, Calendrier, Processus) regroupés en fin de menu sous « Outils du service » pour que le métier ressorte. Cible : 47 écrans, ~150 entrées.
4. [ ] **Renommages** : Présentation → *Modèle Ruches* · Présentation Group → *Vitrine Groupe* · Suivi → *Performance Essaim* · Suivi des Dossiers AO → *Dossiers AO* · Suivi Prestataires → *Missions Prestataires*.
