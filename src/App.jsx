  ...
  return (
    ...
    <div style={isLoggedIn ? {minHeight:'100vh', background:crmTh.isDark?crmTh.bg:crmBg, padding:crmLayout==='sidebar'?'24px 28px 1rem 28px':'1rem', fontFamily:crmTh.font, transition:'background 0.3s', marginLeft:crmLayout==='sidebar'?(crmSideOpen?210:48):0} : {paddingTop:56, fontFamily:'Inter, system-ui, sans-serif', minHeight:'100vh'}}>
      ...
      <div style={{maxWidth:'1600px', margin:'0 auto'}}>
        ...
        {/* ADMINISTRATION */}
        {ongletActif === 'presentation_groupe' && <TabPresentationGroupe {...{ $accent, $bgCard, $bgSub, $border, $text, $textMut, $textSec, ca, chantiers, collaborateurs, crmRd, data, dirigeantDragRef, employes, filialeDragRef, filialesDynamiques, filialesEnrichies, getKpiFiliale, homFilCardSize, isLoggedIn, niveau, ordreDirigeants, ordreFilialesPresentation, resultatNet, setDashboardFiliale, setNavEntreprise, setNavService, setOngletActif, setOrdreDirigeants, setOrdreFilialesPresentation, setShowLoginModal }} />}
      ...
      {ongletActif === 'roadmap' && <TabRoadmap {...{ $accent, $bgCard, $bgSub, $border, $borderAlt, $success, $text, $textMut, $textSec, addRoadmapItem, addRoadmapListItem, ca, crmRd, data, employes, filiales, filialesEnrichies, getKpiFiliale, removeRoadmapItem, removeRoadmapListItem, resetRoadmap, roadmapData, roadmapEditMode, roadmapEditTab, saveRoadmap, setRoadmapEditMode, setRoadmapEditTab, updateRoadmapField, updateRoadmapListItem }} />}
      ...
      {/* ═══════════════════════ MODULE: TRÉSORERIE ═══════════════════════ */}
      {ongletActif === 'tresorerie' && <TabTresorerie {...{ $accent, $bgCard, $bgSub, $border, $borderAlt, $text, $textMut, $textSec, crmRd, data, setTresoFiliale, setTresoTab, tresoFiliale, tresoTab }} />}
