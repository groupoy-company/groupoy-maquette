...
export default function TabDonneesRef(__props) {
  const { $bgSub, $accent, $bgCard, $border, $danger, $shadow, $shadowLg, $text, $textMut, $textSec, autoData, ca, chantiers, collaborateurs, crmRd, drTab, employes, filiales, filialesDynamiques, niveau, setCollabDetailTab, setCollabOngletId, setDrTab, setEmployeForm, setModalEmploye, setOngletActif } = __props;
        ...
        return (
          <div style={{padding:'20px 28px',fontFamily:'system-ui'}}>
            ...
            {/* KPIs */}
            <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit, minmax(140px, 1fr))',gap:1,marginBottom:20,background:'rgba(226,232,240,0.14)'}}>
              {[
            ...
            {/* Tabs */}
            <div style={{display:'flex',gap:0,marginBottom:20,borderBottom:'1px solid #e2e8f0',position:'sticky',top:0,zIndex:40,background:$bgCard,paddingTop:8}}>
              ...
              <div style={{border:'1px solid #e2e8f0'}}>
                <table style={{width:'100%',borderCollapse:'collapse',fontSize:'0.85rem'}}>
                  ...
                  <tbody>{filialesDynamiques.map((f,idx)=>{
                    ...
                    return <tr key={f.id} style={{borderBottom:'1px solid #f1f5f9',background:idx%2===0?$bgCard:$bgSub}}>
              ...
              <div style={{border:'1px solid #e2e8f0',overflowX:'auto'}}>
                <table style={{width:'100%',borderCollapse:'collapse',fontSize:'0.92rem'}}>
                  ...
                  <tbody>{employes.sort((a,b)=>{const n=['XXXL','XXL','XL','L','M','S','XS','XXS'];return n.indexOf(a.niveau)-n.indexOf(b.niveau);}).map((e,idx)=>{
                    ...
                    return <tr key={e.id} onClick={()=> {setCollabOngletId(e.id);setCollabDetailTab('profil');}} style={{borderBottom:'1px solid #f1f5f9',background:idx%2===0?$bgCard:$bgSub,cursor:'pointer'}} onMouseOver={ev=>ev.currentTarget.style.background='#f0f9ff'} onMouseOut={ev=>ev.currentTarget.style.background=idx%2===0?'#fff':'#fafbfc'}>
                      ...
                      <td style={{padding:'6px 10px',fontWeight:700,borderRight:'1px solid #f1f5f9'}}>{e.prenom} {e.nom}{e.statutContrat==='externe'&&<span style={{fontSize:'0.62rem',padding:'1px 4px',background:'rgba(59,130,246,0.14)',color:'#1e40af',fontWeight:700,marginLeft:4}}>EXT</span>}{e.arretMaladie&&<span style={{fontSize:'0.62rem',padding:'1px 4px',background:$danger+'12',color:'#dc2626',fontWeight:700,marginLeft:4}}>ARRÊT</span>}</td>
            ...
            {drTab === 'vehicules' && <div>
              ...
              <div style={{background:'rgba(240,249,255,0.14)',padding:'12px 16px',marginTop:8,borderLeft:'3px solid #0284c7'}}>
            ...
            {drTab === 'materiel' && <div>
              ...
              <div style={{background:'rgba(240,249,255,0.14)',padding:'12px 16px',borderLeft:'3px solid #0891b2'}}>
              ...
              <div style={{border:'1px solid #e2e8f0',overflowX:'auto'}}>
                <table style={{width:'100%',borderCollapse:'collapse',fontSize:'0.92rem'}}>
                  ...
                  <tbody>{allChantiers.sort((a,b)=>new Date(b.dateDebut||0)-new Date(a.dateDebut||0)).map((ch,idx)=>{
                    ...
                    return <tr key={ch.id} style={{borderBottom:'1px solid #f1f5f9',background:idx%2===0?$bgCard:$bgSub}}>
                      ...
                      <td style={{padding:'6px 10px',textAlign:'center',borderRight:'1px solid #f1f5f9'}}><div style={{display:'flex',alignItems:'center',gap:4}}><div style={{flex:1,height:6,background:'rgba(226,232,240,0.14)'}}><div style={{height:'100%',width:`${ch.avancement||0}%`,background:ch.avancement>=100?'#16a34a':ch.avancement>=50?'#0284c7':'#ea580c'}}/></div><span style={{fontSize:'0.72rem',fontWeight:700,minWidth:28}}>{ch.avancement||0}%</span></div></td>
              ...
              <div style={{border:'1px solid #e2e8f0'}}>
                <table style={{width:'100%',borderCollapse:'collapse',fontSize:'0.85rem'}}>
                  ...
                  <tbody>{allClients.map((client,idx)=>{
                    ...
                    return <tr key={client} style={{borderBottom:'1px solid #f1f5f9',background:idx%2===0?$bgCard:$bgSub}}>
            ...
            {drTab === 'prestataires' && <div>
              ...
              <div style={{background:'rgba(250,245,255,0.14)',padding:'14px 18px',borderLeft:'3px solid #8b5cf6',marginBottom:12}}>
                ...
                <table style={{width:'100%',borderCollapse:'collapse',fontSize:'0.85rem'}}>
                  ...
                  <tbody>
                    {['Garage Kuhn','Carglass','Peugeot Molsheim','Dekra Mutzig','Euromaster','LOXAM','LEASEPLAN','France Cars'].map((p,idx)=>
                      <tr key={p} style={{borderBottom:'1px solid #f1f5f9',background:idx%2===0?$bgCard:$bgSub}}>
