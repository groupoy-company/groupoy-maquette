            ...
            {dashboardFiliale !== null && dashboardFiliale !== 'yilmaz' && !isHolding && (() => {
              ...
              return (<>
                ...
                {navEntreprise && navEntreprise !== 'groupoy' && navEntreprise !== 'yilmaz' && (() => {
                  ...
                  const svcStats = [
                    {l:'Services',v:String(svcList.length),i:'▸',c:filAcc},
                  ...
                  return (<div>
                    <div style={{display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:24}}>
                      ...
                      <div style={{display:'flex', gap:8}}>
                        ...
                        <button onClick={() => setConfirmDelete({type:'chantier', id:ch.id, nom:ch.nom})} style={{padding:'6px 14px', borderRadius:crmRd, border:'1px solid #fecaca', background:$danger+'12', cursor:'pointer', fontSize:'0.85rem', fontWeight:600, color:'#dc2626'}}>⊘ Supprimer</button>
                      </div>
                    </div>
