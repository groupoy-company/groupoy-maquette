              ...
              <div style={{maxWidth:1100, margin:'0 auto'}}>
                ...
                <FadeIn delay={200}>
                  <div style={{display:'flex', flexDirection:'column', alignItems:'center'}}>
                    ...
                    <div style={{width:3, height:40, background:'rgba(213,207,197,0.14)'}}></div>

                    <div style={{display:'grid', gridTemplateColumns:'1fr 1fr 1fr', width:'100%', maxWidth:1100, position:'relative'}}>
                      <div style={{position:'absolute', top:0, left:'16.66%', right:'16.66%', height:3, background:'rgba(213,207,197,0.14)'}}></div>

                      {/* COL 1: INVEST EXE */}
                      <div style={{display:'flex', flexDirection:'column', alignItems:'center'}}>
                        <div style={{width:3, height:30, background:'rgba(213,207,197,0.14)'}}></div>
                        ...
                        <div style={{width:2, height:24, background:'rgba(213,207,197,0.14)'}}></div>
                        <div style={{position:'relative', width:'100%', maxWidth:340}}>
                          <div style={{position:'absolute', top:0, left:70, right:70, height:2, background:'rgba(213,207,197,0.14)'}}></div>
                            ...
                            {filialesDynamiques.filter(f => f.holding === 'INVEST EXE').map((f, fi) => {
                              ...
                              return (
                                <div key={fi} style={{display:'flex', flexDirection:'column', alignItems:'center', minWidth:120, maxWidth:150}}>
                                  <div style={{width:2, height:16, background:'rgba(213,207,197,0.14)'}}></div>
